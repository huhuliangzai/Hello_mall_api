...
-- ----------------------------
INSERT INTO `carousel_img` VALUES ('1.jpg');
INSERT INTO `carousel_img` VALUES ('2.jpg');
INSERT INTO `carousel_img` VALUES ('3.jpg');
INSERT INTO `carousel_img` VALUES ('4.jpg');
INSERT INTO `carousel_img` VALUES ('5.jpg');
INSERT INTO `carousel_img` VALUES ('6.jpg');
...
CREATE TABLE `orders`  (
  ...
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '订单状态：1为已收货，2为待收货，3为待评价',
...
-- Records of products
-- ----------------------------
INSERT INTO `products` VALUES (1, 'M6级雪花牛排', '高等极佳级的牛肉分切肌肉间脂肪含量达11%或以上，一般极佳级的牛肉分切肌肉间脂肪含量达9.5%至11% ，次等极佳级的牛肉分切肌肉间脂肪含量达8%至9.5%', 138.00, '500g', '1.jpg', 1);
INSERT INTO `products` VALUES (2, 'M9原切雪花牛排', '高等特选级的牛肉分切肌肉间脂肪含量达7%至8%，一般特选级的牛肉分切肌肉间脂肪含量达5%至6%，次等特选级的牛肉分切肌肉间脂肪含量达4%至5%', 356.00, '500g', '2.jpg', 1);
INSERT INTO `products` VALUES (3, '原切雪花和牛牛肉粒', '含有大量人体所需的脂肪酸，营养价值远远高于普通牛肉。 牛肉方块对切保证了纯厚的口感，也更加耐嚼。 牛肉粒鲜嫩多汁，补脾养胃', 358.00, '500g', '3.jpg', 1);
INSERT INTO `products` VALUES (4, '西冷原切雪花牛排', '当先原切西冷牛排原肉原切，鲜嫩多汁。 纯原切、0添加、非合成、雪花纹理，层次感丰富，轻轻咀嚼肉汁四溢', 288.00, '500g', '4.jpg', 1);
INSERT INTO `products` VALUES (5, 'M6眼肉牛排', '由于取自牛只最不经常活动的上腰部，运动量非常少，也就肉质鲜嫩，油花丰富。 不同于西冷的油花分布在边缘，眼肉的油花多而分布均匀，形成了漂亮的大理石纹，红白相间，成就了眼肉的超高颜值。 因此眼肉牛排被称为beauty steak——美人牛排', 210.00, '500g', '5.jpg', 1);
INSERT INTO `products` VALUES (6, '寿喜烧套餐', '寿喜烧发展至今，仍然分成关东风和关西风两大流派。但作为庶民料理，每家每户使用的食材、调味、甚至制作流程都有着千差万别。就是说，寿喜烧不像寿司、天妇罗、鳗鱼饭，并非很严肃的料理，在民间变化比较多', 168.00, '500g', '6.jpg', 1);
INSERT INTO `products` VALUES (7, '牛肉汉堡肉饼', '牛肉汉堡肉饼是一道简单的家常菜，主料是牛绞肉，鸡蛋，洋葱末，姜末，去边白吐司，牛奶，板油', 250.00, '904g', '1.jpg', 4);
INSERT INTO `products` VALUES (8, '牛腱子肉原切', '牛四条腿大腿部分的肉。因为牛会经常活动，所以这一部分的肉肌肉纤维粗，带筋，少脂肪，有嚼劲', 77.00, '1.5kg', '2.jpg', 4);
INSERT INTO `products` VALUES (9, '国产谷饲肥牛卷', '国内不可多得的西餐用肉食材。 活体重量可达650公斤以上，屠宰率高达55%以上，20%-30%的大型牧场出栏可达7-8百公斤，部分屠宰率高达60%', 158.00, '500g', '3.jpg', 4);
INSERT INTO `products` VALUES (10, '新鲜大猪蹄', '猪蹄，是指猪的脚部（蹄）和小腿，在中国又叫元蹄。在华人世界中，猪蹄是经常被人食用的部位之一，有多种不同的烹调做法。猪蹄含有丰富的胶原蛋白质，脂肪含量也比肥肉低', 138.00, '2kg', '3.jpg', 2);
INSERT INTO `products` VALUES (11, '厚切猪排', '厚切猪排厚切猪排厚切猪排厚切猪排厚切猪排厚切猪排厚切猪排厚切猪排', 56.00, '500g', '2.jpg', 2);
INSERT INTO `products` VALUES (12, '猪廋肉', '猪瘦肉的营养非常全面，不仅为人类提供优质蛋白质和必需的脂肪酸，还提供钙、磷、铁、 硫胺素 、核黄素和尼克酸等营养元素。', 25.00, '500g', '1.jpg', 2);
INSERT INTO `products` VALUES (13, '原切猪排', '原切猪排原切猪排原切猪排原切猪排', 35.00, '500g', '4.jpg', 2);
INSERT INTO `products` VALUES (14, '白羽鸡胸肉', '富含人体必需的多种氨基酸，且利用率较高，是蛋白质的理想来源。 白羽肉鸡胸、腿肌肉发达，脂肪含量少，肉汁丰富，适用于油炸、烧烤，煎炸等鸡肉烹饪方法，是熟食、快餐企业的最好的选择', 65.00, '1kg', '1.jpg', 3);
INSERT INTO `products` VALUES (15, '白羽鸡全腿', '白羽鸡全腿白羽鸡全腿白羽鸡全腿', 50.00, '500g', '2.jpg', 3);
INSERT INTO `products` VALUES (16, '白羽鸡翅根', '白羽鸡翅根白羽鸡翅根白羽鸡翅根白羽鸡翅根', 55.00, '500g', '3.jpg', 3);
INSERT INTO `products` VALUES (17, '白羽鸡中翅', '白羽鸡中翅白羽鸡中翅白羽鸡中翅白羽鸡中翅', 65.00, '500g', '4.jpg', 3);
INSERT INTO `products` VALUES (18, '白羽鸡爪', '白羽鸡爪白羽鸡爪白羽鸡爪', 80.00, '750g', '5.jpg', 3);
INSERT INTO `products` VALUES (19, '白羽鸡胗', '白羽鸡胗白羽鸡胗白羽鸡胗', 80.00, '500g', '6.jpg', 3);
INSERT INTO `products` VALUES (20, '鸡腿肉丁', '鸡腿肉丁鸡腿肉丁鸡腿肉丁鸡腿肉丁鸡腿肉丁', 45.00, '500g', '7.jpg', 3);
INSERT INTO `products` VALUES (21, '白羽鸡翅尖', '白羽鸡翅尖白羽鸡翅尖白羽鸡翅尖', 35.00, '500g', '8.jpg', 3);
INSERT INTO `products` VALUES (22, '蒙古羊肉串30串', '烤羊肉串是新疆人喜爱的风味小吃，肉质鲜嫩，味咸辣，广受人们欢迎。烤羊肉要有专门设备，家庭中没有这种设备时，可油炸羊肉串，味道和烤的羊肉串一样。', 43.00, '30串', '1.jpg', 5);
INSERT INTO `products` VALUES (23, '骨肉相连', '骨肉相连在KFC是一款新口味的休闲产品，它是将新鲜的鸡腿肉加上鸡胸部的脆嫩软骨用特别的香辣调料腌制。一串上有多块软骨、多块鸡肉，滚揉后串上竹签，再用电脑控制的烘烤箱经过特殊工艺烤制而成。', 25.00, '400g', '2.jpg', 5);
INSERT INTO `products` VALUES (24, '谷饲原切牛舌', '一般 厚切都来自舌头的中后端 ，也就是透着粉色、嫩度较高的区域，通常会在肉上切一些刀口，使切口变嫩，如果有酱汁，味道也可以更好的渗入。', 320.00, '300g/袋', '3.jpg', 5);
INSERT INTO `products` VALUES (25, '牛外脊新鲜生牛肉串', '牛外脊/西冷（Striploin）是牛背后半部分一块肌肉的名字。它来自腰部，与肋眼位于同一肌肉群。', 45.00, '30串', '4.jpg', 5);
INSERT INTO `products` VALUES (26, '澳洲原切牛腱子肉', '腱子肉是膝关节往上大腿上的肉。 腱子肉是大腿上的肌肉，有肉膜包裹的，内藏筋，硬度适中，纹路规则，最适合卤味。', 380.00, '1kg', '5.jpg', 5);
INSERT INTO `products` VALUES (27, '冷冻雪花肥牛', '肥牛一词源于美国，后传入中国香港、日本都等地，90年代引入中国香港，后传入中国内陆。', 59.00, '500g', '1.jpg', 6);
INSERT INTO `products` VALUES (28, '手打虾滑', '主要材料有虾，辅料有肉、鱼类等。 虾滑的做法是把虾去壳，通过上千次的摔打，使肉具有粘性，让其保持原有的营养成分，又具有了爽脆的口感。', 66.00, '500g', '2.jpg', 6);
INSERT INTO `products` VALUES (29, '真鳕鱼段', '真鳕鱼是鳕形目鳕科鳕属的鳕鱼，也就是说，一般只有大西洋鳕鱼（Gadus morhua）、太平洋鳕鱼（Gadus macrocephalus）、格陵兰鳕鱼（Gadus ogac）属于真鳕鱼。', 108.00, '500g', '3.jpg', 6);
...
CREATE TABLE `users`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1668165587711950851 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '蔡老六', '123456', '12345678@qq.com', '男', 1380000000, '打原神', '广东省中山市博爱七路25号中山职业技术学院', '1.jpg', '2023-06-05 10:26:15', '2023-06-05 10:26:15');
